                ...
                <TouchableOpacity
                  ...
                  {s.toggle ? (
                    <Switch
                      ...
                      trackColor={{ false: '#1F2E25', true: '#7A3B1E' }}
                      thumbColor="#fff"
                    />
                  ) : (
...
const styles = StyleSheet.create({
  ...
  userName: { fontSize: 20, fontWeight: '800', color: '#E8F0EB', marginBottom: 4 },
  userEmail: { fontSize: 13, color: '#7A9686', marginBottom: 16 },
  loginBtn: {
  ...
  statCard: {
    flex: 1, backgroundColor: '#141E18', borderRadius: 16,
    borderWidth: 1, borderColor: '#1F2E25', padding: 14, alignItems: 'center',
  },
  statVal: { fontSize: 20, fontWeight: '800', color: '#00B896' },
  statLbl: { fontSize: 9, color: '#7A9686', marginTop: 3, textAlign: 'center' },
  ...
  settingsCard: {
    ...
    borderWidth: 1, borderColor: '#1F2E25', marginBottom: 24, overflow: 'hidden',
  },
  settingRow: {
  ...
  settingLabel: { fontSize: 14, color: '#BDD0C3' },
  settingRight: { fontSize: 13, color: '#7A9686' },
  divider: { height: 1, backgroundColor: '#1F2E25', marginHorizontal: 16 },
  ...
  aboutTitle: { fontSize: 15, fontWeight: '700', color: '#E8F0EB', marginBottom: 2 },
  aboutVersion: { fontSize: 11, color: '#7A3B1E', marginBottom: 4 },
  aboutDesc: { fontSize: 12, color: '#3D5445', lineHeight: 17 },
