...
const TYPE_CONFIG = {
  read:     { label: 'Đọc',     color: '#6366F1', bg: '#6366F118' },
            ...
            <View key={mod.week} style={[styles.moduleCard, open && { borderColor: mod.color + '50' }]}>
              <TouchableOpacity
                ...
                {locked
                  ...
                  : <ChevronRight size={18} color="#334155" style={{ transform: [{ rotate: open ? '90deg' : '0deg' }] }} />
                }
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 22, fontWeight: '900', color: '#E0E7FF', textAlign: 'center', marginTop: 14, letterSpacing: -0.5, lineHeight: 28 },
  heroSub: { fontSize: 12, color: '#475569', marginTop: 6, textAlign: 'center' },
  ...
  progressPct: { fontSize: 12, color: '#4F46E5', fontWeight: '700' },
  progressTrack: { height: 6, backgroundColor: '#1E293B', borderRadius: 3 },
  progressFill: { height: 6, backgroundColor: '#4F46E5', borderRadius: 3 },

  moduleCard: {
    backgroundColor: '#0F172A', borderRadius: 18, borderWidth: 1.5, borderColor: '#1E293B',
  ...
  weekNum: { fontSize: 10, color: '#475569', fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5 },
  modTitle: { fontSize: 14, fontWeight: '800', color: '#E0E7FF', marginTop: 1 },
  modDesc: { fontSize: 12, color: '#475569', marginTop: 2, lineHeight: 16 },

  exerciseList: { borderTopWidth: 1, borderTopColor: '#1E293B', paddingHorizontal: 16, paddingBottom: 8 },
  exerciseRow: {
    flexDirection: 'row', alignItems: 'center', gap: 10,
    paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#0F172A',
  },
  exTypeBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  exTypeLabel: { fontSize: 10, fontWeight: '700' },
  exLabel: { flex: 1, fontSize: 13, color: '#CBD5E1' },
  exCircle: { width: 18, height: 18, borderRadius: 9, borderWidth: 1.5, borderColor: '#334155' },

  loginHint: {
    backgroundColor: '#4F46E510', borderRadius: 14, borderWidth: 1, borderColor: '#4F46E530',
    paddingVertical: 14, alignItems: 'center', marginTop: 4,
  },
  loginHintText: { fontSize: 13, color: '#818CF8', fontWeight: '600' },
});
