...
const VIDEOS = [
  { id: 'video31_neuroplasticity', img: 0, bgm: 0, anim: ['particles','pulse'], accent: '#8b5cf6',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Bắt đầu thay đổi hôm nay', cta: '🧠 Khám phá →', url: 'tinnitus.vuinghe.com' },
    ]},
  { id: 'video32_meditation_tinnitus', img: 1, bgm: 4, anim: ['breathe','particles'], accent: '#06b6d4',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Hướng dẫn thiền miễn phí', cta: '🧘 Thiền cùng Tinni →', url: 'tinnitus.vuinghe.com/coach' },
    ]},
  { id: 'video33_stress_brain', img: 7, bgm: 2, anim: ['waves','pulse'], accent: '#ef4444',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Phá vỡ vòng xoáy', cta: '🧘 Bắt đầu →', url: 'tinnitus.vuinghe.com/chat' },
    ]},
  { id: 'video34_cbt_tinnitus', img: 2, bgm: 3, anim: ['particles','waves'], accent: '#10b981',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'AI Coach hướng dẫn CBT', cta: '🧩 Chat với Coach →', url: 'tinnitus.vuinghe.com/coach' },
    ]},
  { id: 'video35_mindfulness', img: 9, bgm: 7, anim: ['breathe','particles'], accent: '#f59e0b',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Guided mindfulness', cta: '🌿 Bắt đầu →', url: 'tinnitus.vuinghe.com/coach' },
    ]},
  { id: 'video36_hearing_anatomy', img: 5, bgm: 1, anim: ['pulse','dna'], accent: '#06b6d4',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Hiểu để chữa lành', cta: '👂 Tìm hiểu →', url: 'tinnitus.vuinghe.com/chat' },
    ]},
  { id: 'video37_sleep_recovery', img: 4, bgm: 6, anim: ['waves','breathe'], accent: '#6366f1',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Sleep mode thông minh', cta: '💤 Ngủ ngon →', url: 'tinnitus.vuinghe.com/sleep' },
    ]},
  { id: 'video38_anxiety_loop', img: 7, bgm: 5, anim: ['pulse','particles'], accent: '#f43f5e',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Phá vỡ vòng lặp', cta: '🧠 Chat với AI →', url: 'tinnitus.vuinghe.com/chat' },
    ]},
  { id: 'video39_pmr', img: 3, bgm: 8, anim: ['breathe','waves'], accent: '#14b8a6',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Hướng dẫn PMR audio', cta: '💆 Bắt đầu →', url: 'tinnitus.vuinghe.com/coach' },
    ]},
  { id: 'video40_habituation', img: 0, bgm: 9, anim: ['dna','particles'], accent: '#a78bfa',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Đẩy nhanh habituation', cta: '🔕 Bắt đầu →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video41_vagus_nerve', img: 3, bgm: 4, anim: ['dna','pulse'], accent: '#22d3ee',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Bài tập Vagus Nerve', cta: '⚡ Thử ngay →', url: 'tinnitus.vuinghe.com/coach' },
    ]},
  { id: 'video42_cortisol', img: 7, bgm: 2, anim: ['waves','particles'], accent: '#fb923c',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Giảm stress mỗi ngày', cta: '🧪 Bắt đầu →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video43_limbic_system', img: 8, bgm: 6, anim: ['pulse','breathe'], accent: '#ec4899',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Retrain hệ limbic', cta: '❤️ Thử ngay →', url: 'tinnitus.vuinghe.com/coach' },
    ]},
  { id: 'video44_deep_breathing', img: 1, bgm: 0, anim: ['breathe','equalizer'], accent: '#34d399',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Hướng dẫn thở miễn phí', cta: '🌬️ Bắt đầu →', url: 'tinnitus.vuinghe.com/coach' },
    ]},
  { id: 'video45_gratitude', img: 9, bgm: 7, anim: ['particles','waves'], accent: '#fbbf24',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Nhật ký trong app', cta: '📝 Viết ngay →', url: 'tinnitus.vuinghe.com/journal' },
    ]},
  { id: 'video46_music_therapy', img: 8, bgm: 1, anim: ['equalizer','particles'], accent: '#8b5cf6',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: '11+ loại âm thanh', cta: '🎶 Nghe ngay →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video47_yoga_nervous', img: 6, bgm: 3, anim: ['breathe','dna'], accent: '#f97316',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Video hướng dẫn', cta: '🧘 Bắt đầu →', url: 'tinnitus.vuinghe.com/coach' },
    ]},
  { id: 'video48_digital_detox', img: 2, bgm: 8, anim: ['particles','pulse'], accent: '#14b8a6',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Thay thế screen time', cta: '📵 Thử ngay →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video49_social_support', img: 8, bgm: 9, anim: ['waves','breathe'], accent: '#3b82f6',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Tinni luôn bên bạn 24/7', cta: '🤝 Chat ngay →', url: 'tinnitus.vuinghe.com/chat' },
    ]},
  { id: 'video50_hope_recovery', img: 1, bgm: 5, anim: ['particles','breathe','equalizer'], accent: '#fbbf24',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Bắt đầu hành trình hôm nay', cta: '🌅 Bước đầu tiên →', url: 'tinnitus.vuinghe.com' },
    ]},
]
