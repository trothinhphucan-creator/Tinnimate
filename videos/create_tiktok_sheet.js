...
async function main() {
  ...
  // Video metadata
  const videos = [
    ['video01_utai_la_gi.mp4', '👂 Ù tai là gì? Tinnitus giải thích đơn giản', 'Bạn có nghe tiếng ù trong tai không? Đó là Tinnitus! TinniMate giúp bạn 💙 tinnitus.vuinghe.com #tinnitus #utai #suckhoe #fyp #tinnimate', 'pending', ''],
    ...
    ['video08_ai_chat.mp4', '🤖 AI Chat — Bạn đồng hành 24/7 khi ù tai', 'Tinni là chatbot AI hiểu về ù tai, sẵn sàng lắng nghe 24/7! 💬 tinnitus.vuinghe.com/chat #aichatbot #tinnitus #AI #fyp #tinnimate', 'pending', ''],
