...
const VIDEOS = [
  ...
  { id: 'video11_white_noise_deep', bgmType: 'white',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Nghe ngay — Miễn phí', cta: '🎧 Bật White Noise →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video12_pink_noise', bgmType: 'pink',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Thử ngay đêm nay', cta: '🌸 Bật Pink Noise →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video13_brown_noise', bgmType: 'brown',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Thư giãn ngay', cta: '🌊 Bật Brown Noise →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  ...
  { id: 'video14_alpha_waves', bgmType: 'alpha',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Nghe với tai nghe', cta: '🧘 Bật Alpha Waves →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video15_theta_waves', bgmType: 'theta',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Nghe trước khi ngủ', cta: '🌙 Bật Theta Waves →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video16_delta_waves', bgmType: 'delta',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Phục hồi mỗi đêm', cta: '💎 Bật Delta Waves →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  ...
  { id: 'video17_174hz', bgmType: 174,
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Nghe miễn phí', cta: '🎵 Bật 174Hz →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video18_417hz', bgmType: 417,
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Thay đổi bắt đầu từ đây', cta: '🔄 Bật 417Hz →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video19_432hz', bgmType: 432,
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Hòa mình vào vũ trụ', cta: '🌍 Bật 432Hz →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video20_528hz', bgmType: 528,
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Chữa lành từ bên trong', cta: '💚 Bật 528Hz →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video21_741hz', bgmType: 741,
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Thanh lọc mỗi ngày', cta: '🔮 Bật 741Hz →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video22_963hz', bgmType: 963,
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Thiền cùng Tinni', cta: '✨ Bật 963Hz →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  ...
  { id: 'video23_rain_sounds', bgmType: 'rain',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: '11 âm thanh tự nhiên', cta: '🌧️ Nghe tiếng mưa →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video24_ocean_waves', bgmType: 'ocean',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Đại dương trong tai nghe', cta: '🌊 Nghe sóng biển →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video25_forest_night', bgmType: 'forest',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Rừng trong tai nghe của bạn', cta: '🌲 Nghe rừng đêm →', url: 'tinnitus.vuinghe.com/therapy' },
    ]},
  { id: 'video26_sound_mixer', bgmType: 'mixer',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Tạo âm thanh riêng bạn', cta: '🎛️ Mở Mixer →', url: 'tinnitus.vuinghe.com/mixer' },
    ]},
  { id: 'video27_sleep_mode', bgmType: 'sleep',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Ngủ ngon mỗi đêm', cta: '🌙 Bật Sleep Mode →', url: 'tinnitus.vuinghe.com/sleep' },
    ]},
  ...
  { id: 'video28_hearing_test', bgmType: 'test',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Test ngay — Không cần đăng ký', cta: '👂 Kiểm tra ngay →', url: 'tinnitus.vuinghe.com/hearing-test' },
    ]},
  { id: 'video29_thi_quiz', bgmType: 'quiz',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Theo dõi tiến triển hàng tháng', cta: '📋 Làm THI Quiz →', url: 'tinnitus.vuinghe.com/chat' },
    ]},
  { id: 'video30_progress_tracking', bgmType: 'progress',
    ...
    scenes: [
      ...
      { heading: '🌐 TinniMate', sub: 'Bắt đầu theo dõi ngay', cta: '📊 Xem Dashboard →', url: 'tinnitus.vuinghe.com/dashboard' },
    ]},
]
